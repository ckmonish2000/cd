import { fetchAccessListForUrlInputType, permissionInputType, revokePermissionInputType } from "@schemas/permission.schema"
import { addUserToAccessList, fetchAccessListById, fetchAccessListForUrl, removeUserFromAccessList } from "@services/permission.service"
import { fetchShotcutById } from "@services/shortcut.service"
import { AppError } from "@utils/tryCatch"
import { Request, Response } from "express"

export const addUserToAccessListHandler = async(req:Request<unknown,unknown,permissionInputType>,res:Response)=>{
...
export const revokeUserToAccessListHandler =async (req:Request<revokePermissionInputType>,res:Response)=>{
