import {
	createShortcutInputType,
	deleteShortcutInputType,
	updateShortcutInputType,
} from "@schemas/shortcut.schema"
import {
	createShortcut,
	deleteShortcut,
	fetchAllUserShortcuts,
	fetchShotcutById,
	updateShortcut,
...
export const createShortcutHandler = async (
	req: Request<unknown, unknown, createShortcutInputType>,
	res: Response
) => {
...
export const updateShortcutHandler = async (
	req: Request<unknown, unknown, updateShortcutInputType>,
	res: Response
) => {
...
export const deleteShortcutHandler = async (
	req: Request<deleteShortcutInputType>,
	res: Response
) => {
...
export const fetchAllUserShortcutsHandler = async (
	req: Request,
	res: Response
) => {
	const userId = req.session.user?.id
